...
import org.quickcached.client.MemcachedException;
	...
	public CASResponse cas(String key, Object value, int ttlSec, long cas, long timeoutMiliSec) 
		...
		try{
			...
			try {
				...
				throw new org.quickcached.client.MemcachedException("CancellationException "+ ce);
	...
	public org.quickcached.client.CASValue gets(String key, long timeoutMiliSec) 
		...
		try{
			...
			try {
				...
				if(cv != null){
					value = new org.quickcached.client.CASValue(cv.getCas(), cv.getValue());
				}else{
					throw new org.quickcached.client.MemcachedException("Object not found");
				}
			}catch(InterruptedException ie){
				throw new org.quickcached.client.MemcachedException("InterruptedException "+ ie);
			}catch(ExecutionException ee){
